  ...
  <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
    <ul class="navbar-nav">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="jabatan.php">Data Jabatan</a>
      </li>
      <li class="nav-item ">
        <a class="nav-link" href="unitkerja.php">Data Unit Kerja <span class="sr-only">(current)</span></a>
      </li>
    </ul>
  </div>
</nav>
...
<!-- Title -->
<center><p class="h1">Daftar Unit Kerja</p></center><br>
